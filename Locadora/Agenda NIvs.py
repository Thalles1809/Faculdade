...
class Agenda(object):
    ...
    def DADOS_INPUT(self):
        ...
        self.nome = str(input("Digite o nome: ")).lower()
        ...
        self.contato = {
            "ID": self.ID + 1,
            "nome": self.nome,
            "email": str(input("Digite o email:")).lower(),
            "telefone": str(input("Digite o telefone: ")).lower(),
            "instagram": str(input("Digite o instagram: ")).lower(),
            "facebook": str(input("Digite o Facebook: ")).lower()
        }
        ...
        for self.contato in self.lista:
            ...
            while True:
                if nome == self.contato["nome"]:
                    ...
                    self.contato["nome"] = str(
                        input("Digite o novo nome: ")).lower()
                    self.contato["email"] = str(
                        input("Digite o novo email:")).lower()
                    self.contato["telefone"] = str(
                        input("Digite o novo telefone: ")).lower()
                    self.contato["instagram"] = str(
                        input("Digite o novo instagram: ")).lower()
                    self.contato["facebook"] = str(
                        input("Digite o novo Facebook: ")).lower()
    ...
    def buscar_contato(self):
        ...
        if len(self.lista) > 0:
            ...
            nome = str(
                raw_input("Digite o nome do contato a ser encontrado: \n")).lower()
            ...
            for self.contato in self.lista:
                if self.contato["nome"] == nome:
                    ...
                    option = str(
                        raw_input("Você deseja modificar? S ou N")).upper()
                    if option == "S":
    ...
    def excluir_dados(self):
        ...
        if option == "S":
            if len(self.lista) > 0:
                ...
                print("Adicione algo.")
                option2 = str(
                    raw_input("Deseja criar os primeiros contatos da sua agenda? S ou N")).upper()
                if option2 == "S":
                    print("=" * 60)
                    self.criar_contato()
        ...
        while True:
            if self.ID > 0:
                ...
                while True:
                    for self.contato in self.lista:
                        nome = str(
                            raw_input("Digite o nome do contato a ser encontrado: ")).lower()
                        if self.contato["nome"] == nome:
                            i = self.contato["ID"] - 1
                            print(self.ID)
                            self.ESTRUTURA_OUTPUT()
                            ...
                            option = str(
                                raw_input("Você tem certeza que deseja excluir?")).upper()
                            if option == "S":
                                while True:
                                    try:
                                        ...
                                        if len(self.lista) <= 1:
                                            print(
                                                "Um foi excluido. {} contato disponivel.".format(lista))
                                            break
                                        else:
                                            print(
                                                "Um foi excluido. {} contatos disponiveis.".format(lista))
                                            break
                                    except IndexError:
                            ...
                            option2 = str(
                                raw_input("Deseja tentar de novo? S ou N")).upper()
                            if option2 == 'N':
                                break
                                self.start_agenda()
                            else:
